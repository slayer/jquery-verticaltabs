...
(function($){  
 $.fn.verticaltabs = function(options) {  
	 ...
	 return this.each(function() {  
		...
		// Initializing Code
		$(contents).addClass("hiddenContent");
		$(contents[defaults.activeIndex]).removeClass("hiddenContent").addClass("activeContent");
		...
		function switchContents() {	
			...
			$(".activeContent", verticaltabs).toggleClass("activeContent").toggleClass("hiddenContent");
			$(contents[activeIndex], verticaltabs).toggleClass("hiddenContent").toggleClass("activeContent"); // Update content
		};
